...
# ticket adds its class to the tuple (see module docstring for the convention).
BACKEND_TO_CLS: dict[str, type[BackendAdapter]] = {cls.backend_type: cls for cls in (OllamaAdapter,)}
